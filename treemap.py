...
RASTER_BUCKET_PATH = "gs://silvx-fastfuels-rasters"
TABLE_BUCKET_PATH = "gs://silvx-fastfuels-tables"
...
class TreeMapConnection(RasterConnection):
    ...
    def __init__(self, version: str, **kwargs):
        ...
        self.raster_path = f"{RASTER_BUCKET_PATH}/TreeMap{version}.tif"
        super().__init__(self.raster_path, connection_type="rioxarray", **kwargs)
        self.table_path = f"{TABLE_BUCKET_PATH}/TreeMap{version}_tree_table.parquet"
